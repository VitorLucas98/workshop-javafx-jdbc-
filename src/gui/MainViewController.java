...
public class MainViewController implements Initializable {
	...
	public void onMenuItemDepartmentAction() {
		loadView2("/gui/DepartmentList.fxml"); // provisoriamente, vou criar outra versão desse loadView
	}
 ...
 */
		...
		private synchronized void  loadView2(String absoluteName) { // absoluteName pq vamos passar o caminho completo
			try {
				FXMLLoader loader = new FXMLLoader(getClass().getResource(absoluteName)); // temos que criar o objeto loader
																							// para carregar
				// uma tela, no caso, vamos abrir o absoluteName que vai ser o caminho do meu
	...
	*/		
	 ...
	 */
				...
				/*
				 Abaixo, vou pegar a referencia para o controller dessa view, ai irei chamar o setDepartmentService para fazer a injeção de 
				 dependencia depois vou chamar o update.
				 
				 Esse é um processo manual de injeção de dependencia no controller e depois eu chamo para atualizar os dados
				 */
